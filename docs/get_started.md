...
```bash
curl -fsSL https://raw.githubusercontent.com/rabilrbl/jiotv_go/main/scripts/install.sh | bash
```
...
```powershell
iwr -useb https://raw.githubusercontent.com/rabilrbl/jiotv_go/main/scripts/install.ps1 | iex
```
