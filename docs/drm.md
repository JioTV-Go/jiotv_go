...
*   **IPTV Client Compatibility:** DRM streams are now fully supported in IPTV clients (like Kodi or Tivimate) that support Widevine L3 via `#KODIPROP` directives. If your app does not support this (or if channels do not play), make sure to disable DRM.
...
See [config.md](./config.md#drm-digital-rights-management) for how to enable/disable DRM.
